...
registerADMooseObject("CraneApp", InterpolatedCoefficientSpline);
...
InterpolatedCoefficientSpline::InterpolatedCoefficientSpline(const InputParameters & parameters)
...
void
InterpolatedCoefficientSpline::computeQpProperties()
{

...
registerMooseAction("CraneApp", AddScalarBase, "add_aux_variable");
registerMooseAction("CraneApp", AddScalarBase, "add_aux_scalar_kernel");
registerMooseAction("CraneApp", AddScalarBase, "add_scalar_kernel");
registerMooseAction("CraneApp", AddScalarBase, "add_function");
registerMooseAction("CraneApp", AddScalarBase, "add_user_object");

template <>
InputParameters
validParams<AddScalarBase>()
{
...
AddScalarBase::AddScalarBase(InputParameters params)
...
AddScalarBase::act()
{
  ...
  std::cout << _num_reactions << std::endl;
  mooseError("TEST");
  int v_index;
